...
const TOOLS = [
  ...
  { name: "Kiro", icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" width="24" height="24"><path d="M2 12L12 2l10 10-10 10L2 12z" /></svg> },
