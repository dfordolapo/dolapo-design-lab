...
const TOOLS = [
  ...
  { name: "Kiro", icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" width="24" height="24"><rect x="3" y="11" width="18" height="10" rx="2" /><circle cx="12" cy="5" r="2" /><path d="M12 7v4" /><line x1="8" y1="16" x2="8" y2="16" /><line x1="16" y1="16" x2="16" y2="16" /></svg> },
  ...
  { name: "React", icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" width="24" height="24"><circle cx="12" cy="12" r="3"/><ellipse cx="12" cy="12" rx="10" ry="4.5" transform="rotate(60 12 12)"/><ellipse cx="12" cy="12" rx="10" ry="4.5" transform="rotate(-60 12 12)"/><ellipse cx="12" cy="12" rx="10" ry="4.5"/></svg> },
  { name: "TypeScript", icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" width="24" height="24"><path d="M4 4h16v16H4V4z"/><path d="M9 10v6M7.5 10h3M13.5 12.5c1 0 1.5 0.5 1.5 1.5s-0.5 1.5-1.5 1.5-1.5-0.5-1.5-1M13.5 10.5c-1 0-1.5 0.5-1.5 1"/></svg> },
  { name: "Tailwind CSS", icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" width="24" height="24"><path d="M12 6c-2.5 0-4 1.5-4 4s1.5 3 3 4 2 1.5 2 3-1.5 3-3 3M15 6c-2.5 0-4 1.5-4 4s1.5 3 3 4 2 1.5 2 3-1.5 3-3 3"/></svg> },
  { name: "Node.js", icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" width="24" height="24"><path d="M12 2l9 5v10l-9 5-9-5V7l9-5z"/><path d="M12 22V12M21 7l-9 5M3 7l9 5"/></svg> },
  { name: "HTML", icon: <svg viewBox="0 0 24 24" fill="currentColor" width="24" height="24"><path d="M3 2l1.5 17L12 22l7.5-3L21 2H3zm15 15.5l-6 1.5-6-1.5-.5-5h2.5l.3 2.5 3.7 1 3.7-1 .3-3.5H7.5l-.5-5h10l-1 10z"/></svg> },
  { name: "CSS", icon: <svg viewBox="0 0 24 24" fill="currentColor" width="24" height="24"><path d="M3 2l1.5 17L12 22l7.5-3L21 2H3zm15 15.5l-6 1.5-6-1.5-.5-5h2.5l.3 2.5 3.7 1 3.7-1 .3-3.5H7.5l-.5-5h10l-1 10z"/></svg> },
  { name: "JavaScript", icon: <svg viewBox="0 0 24 24" fill="currentColor" width="24" height="24"><path d="M3 3h18v18H3V3zm11 12.5c0-1.5-2.5-1.5-2.5-3s2.5-1.5 2.5-1.5 1 .5 1 2h2c0-2.5-1.5-3.5-3-3.5s-4.5 1.5-4.5 3.5 2.5 2 4.5 3c.5.5.5 1 .5 1.5s-.5 1-1.5 1-1.5-.5-1.5-1.5h-2c0 2 1.5 3.5 3.5 3.5s4.5-1.5 4.5-3.5zm-6 2c0 1.5-1 3-3 3s-3-1.5-3-3h2c0 .5.5 1 1 1s1-.5 1-1V9H8v7.5z"/></svg> }
];
    ...
    <div className={`lab-loading-screen ${visible ? 'is-visible' : ''}`}>
      <div className="lab-loading-main">
        <div className="lab-loading-top">
          <img src={theme === 'light' ? "/assets/logo-light.webp" : "/assets/logo-dark.webp"} alt="Dolapo's Design Lab" className="welcome-logo" decoding="async" />
        </div>
