...
const TOOLS = [
  // Line 1: Tailwind CSS, JavaScript, CSS
  ...
  // Line 2: TypeScript, PostgreSQL, HTML
  { name: "TypeScript", icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" width="16" height="16"><path d="M4 4h16v16H4V4z"/><path d="M9 10v6M7.5 10h3M13.5 12.5c1 0 1.5 0.5 1.5 1.5s-0.5 1.5-1.5 1.5-1.5-0.5-1.5-1M13.5 10.5c-1 0-1.5 0.5-1.5 1"/></svg> },
  ...
  // Line 3: Google Docs, Antigravity, React
  ...
  { name: "React", icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" width="16" height="16"><circle cx="12" cy="12" r="3"/><ellipse cx="12" cy="12" rx="10" ry="4.5" transform="rotate(60 12 12)"/><ellipse cx="12" cy="12" rx="10" ry="4.5" transform="rotate(-60 12 12)"/><ellipse cx="12" cy="12" rx="10" ry="4.5"/></svg> },

  // Line 4: OpenCode, Node.js, Kiro
  ...
  { name: "Kiro", icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" width="16" height="16"><rect x="3" y="11" width="18" height="10" rx="2" /><circle cx="12" cy="5" r="2" /><path d="M12 7v4" /><line x1="8" y1="16" x2="8" y2="16" /><line x1="16" y1="16" x2="16" y2="16" /></svg> },

  // Line 5: Claude, Gemini, Figma
                ...
                <ScrollReveal variant="fadeUp" delay={0.4}>
                  <div className="bio-section" style={{ alignItems: 'center' }}>
                    ...
                    <div className="social-links">
                      <a href="mailto:dfordolapo@gmail.com" className="social-link" rel="noopener noreferrer">
                ...
                <ScrollReveal variant="fadeIn">
                  <div className="manifest-section">
                    {[
                      ...
                      { icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"/></svg>, title: 'Tools & Languages', tools: TOOLS },
                    ].map((cat, i) => (
                        ...
                        <div className="manifest-category">
                          ...
                          <div className="manifest-badges">
                            {cat.badges ? cat.badges.map((badge, j) => (
                              ...
                              <div key={j} className="manifest-badge" style={{display: 'flex', alignItems: 'center', gap: '6px'}}>
                                {tool.icon} {tool.name}
                              </div>
                            ))}
                          </div>
