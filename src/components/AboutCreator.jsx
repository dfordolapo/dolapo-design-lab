...
const TOOLS = [
  ...
  { name: "FigJam", icon: <svg viewBox="0 0 24 24" fill="currentColor" width="16" height="16"><path d="M5.5 12A6.5 6.5 0 0 1 12 5.5v6.5H5.5z"/><path d="M12 18.5A6.5 6.5 0 0 0 18.5 12H12v6.5z"/><path d="M18.5 5.5A6.5 6.5 0 0 1 12 12V5.5h6.5z"/></svg> },
  { name: "Framer", icon: <svg viewBox="0 0 24 24" fill="currentColor" width="16" height="16"><path d="M4 0h16v8h-8zM4 8h8l8 8H4zM4 16h8v8z"/></svg> },
  { name: "GitHub", icon: <svg viewBox="0 0 24 24" fill="currentColor" width="16" height="16"><path d="M12 .297c-6.63 0-12 5.373-12 12 0 5.303 3.438 9.8 8.205 11.385.6.113.82-.258.82-.577 0-.285-.01-1.04-.015-2.04-3.338.724-4.042-1.61-4.042-1.61C4.422 18.07 3.633 17.7 3.633 17.7c-1.087-.744.084-.729.084-.729 1.205.084 1.838 1.236 1.838 1.236 1.07 1.835 2.809 1.305 3.495.998.108-.776.417-1.305.76-1.605-2.665-.3-5.466-1.332-5.466-5.93 0-1.31.465-2.38 1.235-3.22-.135-.303-.54-1.523.105-3.176 0 0 1.005-.322 3.3 1.23.96-.267 1.98-.399 3-.405 1.02.006 2.04.138 3 .405 2.28-1.552 3.285-1.23 3.285-1.23.645 1.653.24 2.873.12 3.176.765.84 1.23 1.91 1.23 3.22 0 4.61-2.805 5.625-5.475 5.92.42.36.81 1.096.81 2.22 0 1.606-.015 2.896-.015 3.286 0 .315.21.69.825.57C20.565 22.092 24 17.592 24 12.297c0-6.627-5.373-12-12-12"/></svg> },
          ...
          <div className="about-tab-content">
            {activeTab === 'bio' ? (
              <>
                ...
                <div className="bio-section">
                  <span className="bio-section__title">How I Think</span>
                  <p className="bio-section__text">
                    I don't see screens as just screens.<br/>
                    A button is a tiny decision.<br/>
                    A sentence is a tiny conversation.<br/>
                    A user flow is a tiny story.<br/>
                    Every detail has a job.
                  </p>
                </div>

                <div className="bio-section">
                  <span className="bio-section__title">My three labs</span>
                  <div className="bio-card-container">
                    <div className="bio-card">
                      <span className="bio-card__title">Product Design</span>
                      <span className="bio-card__desc">Turning problems into experiences people can use.</span>
                    </div>
                    <div className="bio-card">
                      <span className="bio-card__title">UX Writing</span>
                      <span className="bio-card__desc">Helping products speak clearly without sounding like a manual.</span>
                    </div>
                    <div className="bio-card">
                      <span className="bio-card__title">Design + Build</span>
                      <span className="bio-card__desc">Taking ideas from a blank canvas to something real.</span>
                    </div>
                  </div>
                </div>
                
                <div className="about-footer">
                  Always learning. Always building. Still collecting ideas.
                ...
                <div className="manifest-section">
                  <div className="manifest-category">
                    <div className="manifest-category__header">
                      <span className="manifest-category__icon">
                    ...
                    <div className="manifest-badges">
                      <div className="manifest-badge">Product thinking & discovery</div>
                      <div className="manifest-badge">User flow architecture</div>
                      <div className="manifest-badge">Brand direction & strategy</div>
                      <div className="manifest-badge">End-to-end product lifecycle</div>
                    </div>
                  </div>
                  ...
                  <div className="manifest-category">
                    ...
                    <div className="manifest-badges">
                      <div className="manifest-badge">UX microcopy & interface language</div>
                      <div className="manifest-badge">Content strategy & audits</div>
                      <div className="manifest-badge">Product voice & narrative</div>
                    </div>
                  </div>
                  ...
                  <div className="manifest-category">
                    ...
                    <div className="manifest-badges">
                      <div className="manifest-badge">Front-end development</div>
                      <div className="manifest-badge">Interactive experiences</div>
                      <div className="manifest-badge">Web experiences & PWA builds</div>
                      <div className="manifest-badge">AI-assisted workflows</div>
                    </div>
                  </div>
                </div>
              </>
