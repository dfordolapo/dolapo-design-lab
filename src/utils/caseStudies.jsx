  ...
  
  {
    ...
    content: [
      ...
      },
      {
        ...
        body: 'Junior designers often struggle to land interviews because their portfolios lack the structural storytelling and business framing that hiring managers look for. Furthermore, existing portfolio feedback is often too vague to be helpful and not easily accessible. Human mentorship is expensive and hard to come by, leaving many designers guessing what they are doing wrong.'
      },
      {
        type: 'text-block',
        heading: 'Solution',
        body: 'I designed and engineered Vurdict to act as an automated design mentor. By analyzing a portfolio URL against industry rubrics, Vurdict generates a comprehensive feedback report in under 60 seconds, highlighting strengths and pinpointing exact areas for improvement.'
      },
      {
        type: 'text-block',
        heading: 'Tech Stack',
